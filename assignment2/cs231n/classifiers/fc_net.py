...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        X2, fc1_cache = affine_relu_forward(X, W1, b1)
        scores, fc2_cache = affine_relu_forward(X2, W2, b2)
        ...
        dfc2, dW2, db2 = affine_relu_backward(dout, fc2_cache)
        dfc1, dW1, db1 = affine_relu_backward(dfc2, fc1_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 2, -1, -1):
            if self.use_dropout:
                dout = dropout_backward(dout, do_caches[i])
